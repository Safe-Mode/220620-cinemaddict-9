...
const getFilmDetailsTpl = ({poster, age, title, rate, director, writers, actors, release, duration, country, genres, description, comments}) => {
  return `
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${new Intl.DateTimeFormat(`en-GB`, {day: `2-digit`, month: `long`, year: `numeric`}).format(release)}</td>
                </tr>
                <tr class="film-details__row">
                  <td class="film-details__term">Runtime</td>
                  <td class="film-details__cell">${parseInt(duration / MIN_PER_HOUR, RADIX_TEN)}h ${duration % MIN_PER_HOUR}m</td>
                </tr>
                <tr class="film-details__row">
