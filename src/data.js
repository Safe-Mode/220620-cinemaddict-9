const POSTERS_ENDPOINT = `../markup/posters/`;
...
const filmCard = {
  poster: [
    `${POSTERS_ENDPOINT}made-for-each-other.png`,
    `${POSTERS_ENDPOINT}popeye-meets-sinbad.png`,
    `${POSTERS_ENDPOINT}sagebrush-trail.jpg`,
    `${POSTERS_ENDPOINT}santa-claus-conquers-the-martians.jpg`,
    `${POSTERS_ENDPOINT}the-dance-of-life.jpg`,
    `${POSTERS_ENDPOINT}the-great-flamarion.jpg`,
    `${POSTERS_ENDPOINT}the-man-with-the-golden-arm.jpg`,
  ][getRandomInt(0, 7)],
  title: (() => {
    return new Array(getRandomInt(1, 3)).fill(``).reduce((title) => `${title} ${TITLE_FISH[getRandomInt(0, TITLE_FISH.length)]}`.trim(), ``);
  })(),
